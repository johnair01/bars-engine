---
name: compute-guardrails
description: Compute resource guardrails to prevent unproductive loops. Use when encountering repeated errors or stuck in a loop.
---

# Skill: Compute Guardrails
...
## Escalation Protocol
1. **Document** the blocker clearly in the task or conversation.
2. **Notify** the user with options.
3. **Don't** retry the same approach indefinitely.

## Preferred Verification Order
1. **Scripts** (`validate-release.ts`, `npm run check`) - fastest, most reliable
