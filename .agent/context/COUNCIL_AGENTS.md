...
**Source of truth:** This file is the canonical reference for all Council agents.
**Location:** `.agent/context/COUNCIL_AGENTS.md` (agent memory) + `docs/COUNCIL_AGENTS.md` (workspace)
**Updated:** 2026-04-14
...
1. **One text per night maximum.** If you found nothing novel, send nothing. The standup covers what didn't fire.
2. **Text must include:**
...
Current agents: See `.agent/AGENTS.md` or run `list_agents` in Zo Automations.
Agent state is tracked in: `docs/COUNCIL_AGENT_STATE.md`
If you lose track of what exists → read `docs/COUNCIL_AGENT_STATE.md` first.
