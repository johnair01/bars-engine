...
const ROOMS: { href: string; label: string; color: string }[] = [
    { href: '/vault/charges', label: 'Charges', color: 'text-rose-400 border-rose-800/50 bg-rose-950/20 hover:border-rose-700/60' },
    { href: '/vault/quests', label: 'Quests', color: 'text-amber-400 border-amber-800/50 bg-amber-950/20 hover:border-amber-700/60' },
    { href: '/vault/drafts', label: 'Drafts', color: 'text-purple-400 border-purple-800/50 bg-purple-950/20 hover:border-purple-700/60' },
    { href: '/vault/invitations', label: 'Invitations', color: 'text-emerald-400 border-emerald-800/50 bg-emerald-950/20 hover:border-emerald-700/60' },
]
