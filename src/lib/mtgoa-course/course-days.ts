 ...
 *
 * Round 3 is Gather Resources, decided by the Day 11 design, and now fully
 * authored — all five moves carry a question here. Rounds 4–6 remain undecided and
...
const ROUND_AUTHORING: Record<number, RoundAuthoring> = {
  ...
  3: {
    ...
    days: {
      ...
      show_up:  { question: 'What resourcing move can another person actually act on?',  output: 'one real move' },
    },
  },
}
...
/**
 * Round 3 — Days 11–15, Gather Resources, complete. All five answer on the
 * canonical course route. Day 16 opens Round 4, which is unauthored, so Day 15's
 * forward handoff renders as "coming next" rather than a link.
 */
