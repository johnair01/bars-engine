    ...
    const playbooks = [
        {
            ...
            openUp: 'Open Horizon: Let the vast pattern pour in; welcome a calling larger than your plan.',
        ...
        },
        {
            ...
            openUp: 'Open Ground: Soften the soil and let new seeds settle; receive what asks to be tended.',
        ...
        },
        {
            ...
            openUp: 'Open Sky: Let the charge gather; welcome the sudden and the unplanned.',
        ...
        },
        {
            ...
            openUp: 'Open Depths: Let the hidden currents surface; receive what is beneath before you move.',
        ...
        },
        {
            ...
            openUp: 'Open Stillness: In the quiet, let what wants to arise arise; receive without reaching.',
        ...
        },
        {
            ...
            openUp: 'Open Field: Widen your attention to faint signals; receive the small before naming the large.',
        ...
        },
        {
            ...
            openUp: 'Open Light: Let illumination reveal more than you sought; welcome truths you did not ask for.',
        ...
        },
        {
            ...
            openUp: 'Open Arms: Let others and their delight in; welcome connection before sorting it.',
    ...
    await prisma.customBar.upsert({
        ...
        update: {
            ...
            inputs: JSON.stringify([
                ...
                { key: 'feedback', label: 'Transmission', type: 'textarea', required: true, placeholder: 'What specific friction or magic did you encounter?' },
                {
                    key: 'signalImageUrl',
                    label: 'Screenshot',
                    type: 'image',
