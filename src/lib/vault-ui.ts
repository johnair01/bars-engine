/**
 * Vault (`/vault`) UI constants — align with [.specify/specs/vault-page-experience/spec.md](../../.specify/specs/vault-page-experience/spec.md)
...
/** Nested room pages (`/vault/charges`, etc.) fetch more rows than the lobby snapshot. */
