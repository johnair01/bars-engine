...
const deck: DeckTemplate = {
  ...
  cardSeed: [
    ...
    },
    {
      ...
      bodyText:
        'What decision or action is being held up because the right people are not in conversation? Name who is missing. Name one concrete step to get them there. Take it before the next meeting.',
      faceKey: null,
      archetypeKey: null,
      nationKey: null,
      moveType: 'grow_up',
