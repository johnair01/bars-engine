    ...
    return (
        <div className="min-h-screen text-zinc-200 font-sans p-6 sm:p-12 max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-xs text-zinc-500">
                <Link href="/vault/moves" className="text-zinc-400 hover:text-zinc-300">
                    4 Moves reference
                </Link>
                {' · '}
                <Link href="/vault/drafts" className="text-purple-400 hover:text-purple-300">
                    Drafts room
                </Link>
                {' · '}
                <Link href="/vault/quests" className="text-amber-400/90 hover:text-amber-300">
                    Quests room
                </Link>
            </p>
