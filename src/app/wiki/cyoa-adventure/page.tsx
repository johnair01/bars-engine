...
const MOVES = [
  {
    ...
    meaning: 'See more of what is available',
    detail:
      "A Wake Up adventure asks you to raise awareness — to look clearly at something you've been avoiding or missing. The path tends toward noticing, honest naming, and threshold-crossing.",
  },
  {
    key: 'cleanUp',
    name: 'Clean Up',
    ...
    bg: 'bg-sky-950/20',
    meaning: 'Unblock emotional energy',
    detail:
      'A Clean Up adventure moves emotional energy through you. The path tends toward metabolizing what is stuck — processing charge so you can act from clarity rather than reactivity.',
  },
  {
    key: 'growUp',
    name: 'Grow Up',
    ...
    bg: 'bg-violet-950/20',
    meaning: 'Expand capacity at developmental edges',
    detail:
  ...
  },
  {
    ...
    bg: 'bg-amber-950/20',
    meaning: 'Do the work — complete quests, take action',
    detail:
