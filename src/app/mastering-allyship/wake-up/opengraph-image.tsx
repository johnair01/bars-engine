...
/**
 * Social preview for Day 1. The card is drawn by the shared renderer from the
 * day's own copy, so this file carries no design and no strings of its own.
 */

const DAY = courseIndexDay(1)
...
export default function Image() {
  if (!DAY) throw new Error('Day 1 is missing from the course spine.')
