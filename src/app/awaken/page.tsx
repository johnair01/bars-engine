 ...
 *   narrative), then show up — pay toward the press run via the Crossing campaign,
...
export const metadata: Metadata = {
  ...
  description:
    'See where the press run stands, then choose how to show up: chip in via the Crossing, help with the book tour, get the deck, or read Chapter One.',
}
