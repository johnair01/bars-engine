  ...
  return normalizeAwakenPageContent({
    ...
    moves: {
      ...
      chapter: {
        ...
        doneTitle: formText(
          formData,
          'moves.chapter.doneTitle',
          defaults.moves.chapter.doneTitle ?? ''
        ),
        doneBody: formText(formData, 'moves.chapter.doneBody', defaults.moves.chapter.doneBody ?? ''),
      },
      events: {
        ...
        doneTitle: formText(formData, 'moves.events.doneTitle', defaults.moves.events.doneTitle ?? ''),
        doneBody: formText(formData, 'moves.events.doneBody', defaults.moves.events.doneBody ?? ''),
        helperTitle: formText(
          formData,
          'moves.events.helperTitle',
          defaults.moves.events.helperTitle ?? ''
        ),
      },
    },
