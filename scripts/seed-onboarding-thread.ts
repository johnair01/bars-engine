    ...
    const STARTER_QUESTS: { id: string; title: string; description: string; allyshipDomain: string; passages?: { name: string; pid: string; text: string; cleanText: string; links: { label: string; target: string }[] }[] }[] = [
        {
            ...
            passages: [
                ...
                { name: 'END_DONATE', pid: '2', text: 'You chose to contribute support. Visit [the contribution wizard](/event/donate/wizard) to strengthen the residency. Your contribution helps the community grow.', cleanText: 'Contribute support.', links: [] },
