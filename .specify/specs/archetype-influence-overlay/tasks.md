# Tasks: Archetype Influence Overlay v1

- [x] Create `src/lib/archetype-influence-overlay/types.ts` with `ArchetypeInfluenceProfile`
- [x] Create `src/lib/archetype-influence-overlay/profiles.ts` with all 8 profiles
- [x] Create `getArchetypeInfluenceProfile(archetypeKey)` in index
