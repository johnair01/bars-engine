...
- [x] Create `.specify/backlog/prompts/psychofauna-inner-work-collectibles.md` (inner work types, unlock criteria, collectible schema sketch, use-in-quests)
...
## Phase 3: Psychofauna (deferred)

- [ ] Create full spec from psychofauna prompt when ready
