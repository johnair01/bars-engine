...
| 4 | D | Intention-Activated Value (Philosophy & Docs) | Docs | [/] In-Progress | - |
...
| 27 | AE | [Story/Quest Map Exploration](.specify/specs/story-quest-map-exploration/spec.md) | UI/Exploration | [/] Spec done | - |
...
| 0.38 | DA | [Quest Wizard Template Alignment](.specify/specs/quest-wizard-template-alignment/spec.md) (deprecate Party Prep, Connection, Inner↔External; refine Dreams & Schemes; Personal Development = Grow Up) | UI | [ ] Ready | - |
...
| 0.43 | DF | [Branching Quest](.specify/specs/branching-quest/spec.md) (I Ching in-quest; Altitude Map 6 options, collapsible, reorderable; per-node choice type altitudinal/horizontal; 3-layer depth limit) | UI/Infra | [ ] Ready | BY, DC |
...
| 0.45 | DH | [AID Decline Fork, Clock, and Lore](.specify/specs/aid-decline-fork-clock-lore/spec.md) (decline clock; fork-on-decline; Jira–GitHub–CYOA metaphor; Architect as sys-admin teacher) | UI/Docs | [ ] Ready | DB |
...
| 0.51 | DN | [Onboarding Flow Completion](.specify/specs/onboarding-flow-completion/spec.md) (state machine API; Strengthen 4 branches; visible effects; cert-onboarding-flow-completion-v1) | UI/Infra | [ ] Ready | DM, CG |
...
| 0.55 | DR | [Twine Authoring IR + Twee Compiler](.specify/specs/twine-authoring-ir/spec.md) (IR schema, irToTwee, validateIrStory, compile/validate APIs; mobile admin UI; compiler-first) | UI/Infra | [ ] Ready | - |
...
**Onboarding flow status (Mar 2025)**: DG, DQ, DS, DM done. Remaining blocker: DN (Onboarding Flow Completion). Defer DR (Twine IR) until mobile admin needed; DJ/DK (quest generation) are admin-side, not player flow.
