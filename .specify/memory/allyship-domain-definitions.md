# Allyship Domain Definitions (Emergent Problem → Domain)

Canonical definitions for when each domain applies. Use when writing quests, intentions, and campaign content.
...
Intention options should map to domains (or be domain-agnostic):

| Intention Key | Domain | Example Phrase |
|---------------|--------|----------------|
| curiosity | (agnostic) | "I intend to follow my curiosity" |
| skillful_organizing | SKILLFUL_ORGANIZING | "I intend to help build systems that solve what's emergent" |
| gathering_resources | GATHERING_RESOURCES | "I intend to contribute resources to the cause" |
| raise_awareness | RAISE_AWARENESS | "I intend to help people see what's available" |
| direct_action | DIRECT_ACTION | "I intend to take action and remove obstacles" |
