...
state: canonical
promoted: 2026-06-02
export_surface: manuscripts/chapters/ch4-REGENT/CHAPTER4_REGENT_FULL_DRAFT.md
---
...
This note is the canonical Obsidian container for Chapter 4 — Regent manuscript text and chapter-level editorial state.
...
`manuscripts/chapters/ch4-REGENT/CHAPTER4_REGENT_FULL_DRAFT.md`
...
Nothing says "shared values" like a structure so committed to continuity that it can survive the disappearance of everyone it was for.
...
- `manuscripts/sources/integral-design/chapter-polarities/`
