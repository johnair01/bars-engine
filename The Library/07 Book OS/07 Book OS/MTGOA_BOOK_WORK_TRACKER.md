...
- Ch5 removes the lingering **Transcend Outcome** table label in favor of **Integrated Outcome**
- Ch6 replaces **Transcend 1/2** and numeric **Energy cost** labels with **Alchemy 1/2** plus sustaining/costly capacity language
- Ch7 replaces **Transcend Move 1-5** with **Alchemy Move 1-5**
...
- [[CH2_CH4_ECOLOGY_SEQUENCE_READBACK_2026-06-04]]
- [[SPEC_CH5_CH8_ENERGY_LANGUAGE_SWEEP_2026-06-04]]
...
- [[SPEC_CH1_HUMANE_TEACHING_CONSENT_FRAME_2026-06-03]]
- [[SPEC_GATE2_CONTROLLER_CONSISTENCY_2026-06-03]]
- [[CH1_HUMANE_TEACHING_TO_GATE4_READBACK_2026-06-03]]
- [[CH1_FULL_GATES_PLAYABLE_SEQUENCE_READBACK_2026-06-03]]
...
| **What it produces** | A named alchemy/capacity move the player can practice without point-scoring | A regulated body that can then run a Move |
