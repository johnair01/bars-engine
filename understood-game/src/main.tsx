...
const demoSteps = [
  { title: 'Meet the emotional chips', body: 'Each chip holds one emotional bid. Explore the five colors and flip a chip, then guide Ari and Bea through a disagreement about a changed plan.', cta: 'Begin the rehearsal' },
