...
Canonical index of proper nouns used in the Event Page, CYOA onboarding, and knowledge base. Each term has a slug and optional wiki path.

## Campaign

| Term | Slug | Wiki Path |
|------|------|-----------|
| Bruised Banana Residency | bruised-banana-residency | /wiki/campaign/bruised-banana |
| Bruised Banana Fundraiser | bruised-banana-fundraiser | /wiki/campaign/bruised-banana |
| Bruised Banana Campaign | bruised-banana-campaign | /wiki/campaign/bruised-banana |

## People

| Term | Slug | Wiki Path |
|------|------|-----------|
| Wendell Britt | wendell-britt | /wiki/campaign/bruised-banana |
| Eddy | eddy | /wiki/campaign/bruised-banana |
| JJ | jj | /wiki/campaign/bruised-banana |
...
| Term | Slug | Wiki Path |
|------|------|-----------|
| Gathering Resources | gathering-resources | /wiki/domains |
| Direct Action | direct-action | /wiki/domains |
| Raise Awareness | raise-awareness | /wiki/domains |
| Skillful Organizing | skillful-organizing | /wiki/domains |

## 4 Moves (Personal Throughput)

| Term | Slug | Wiki Path |
|------|------|-----------|
| Wake Up | wake-up | /wiki/moves |
| Clean Up | clean-up | /wiki/moves |
...
| Term | Slug | Wiki Path |
|------|------|-----------|
| Urgency | urgency | /wiki/glossary#kotter |
| Coalition | coalition | /wiki/glossary#kotter |
| Vision | vision | /wiki/glossary#kotter |
| Communicate | communicate | /wiki/glossary#kotter |
| Obstacles | obstacles | /wiki/glossary#kotter |
| Wins | wins | /wiki/glossary#kotter |
| Build On | build-on | /wiki/glossary#kotter |
| Anchor | anchor | /wiki/glossary#kotter |
